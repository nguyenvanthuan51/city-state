...
module CS
    ...
    def self.update
        ...
        @countries, @states, @provinces, @cities = [{}, {}, {}] # invalidades cache
    ...
    def self.install(country)
        ...
        File.chmod(0o666, states_fn, provinces_fn, cities_fn, cities_provinces_fn) # force permissions to rw_rw_rw_ (issue #3)
        true
    end
